...
public:
    ...
    void encadenar(ListLinkedDouble& other);
...
// No olvides el coste!
void ListLinkedDouble::encadenar(ListLinkedDouble& other) {
    if (other.empty()) {
        return;
    }
    ...
    if (current_other != other.head) {
        // If other still has nodes, attach them at the end of this list
        Node* last_this = head->prev;

        last_this->next = current_other;
        current_other->prev = last_this;
        current_other->next = this->head;
        this->head->prev = current_other;
